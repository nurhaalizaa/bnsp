    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Edit Kegiatan</h5>
                <div class="card">
                <div class="card-body">
                <?php
                    $id = $_GET['id'];
                ...
                <form action="proses_edit_kegiatan.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $kegiatan['id']; ?>"> <!-- Input tersembunyi untuk menyimpan ID kegiatan -->
                    <div class="mb-3">
                        <label for="judulKegiatan" class="form-label">Judul Kegiatan</label>
                        <input type="text" class="form-control" id="judulKegiatan" name="judulKegiatan" value="<?php echo $kegiatan['judul']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="deskripsiKegiatan" class="form-label">Deskripsi Kegiatan</label>
                        <textarea class="form-control" id="deskripsiKegiatan" name="deskripsiKegiatan"><?php echo $kegiatan['deskripsi']; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="tanggalKegiatan" class="form-label">Tanggal Kegiatan</label>
                        <input type="date" class="form-control" id="tanggalKegiatan" name="tanggalKegiatan" value="<?php echo $kegiatan['tanggal']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="waktuKegiatan" class="form-label">Waktu Kegiatan</label>
                        <input type="time" class="form-control" id="waktuKegiatan" name="waktuKegiatan" value="<?php echo $kegiatan['waktu']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="lokasiKegiatan" class="form-label">Lokasi Kegiatan</label>
                        <input type="text" class="form-control" id="lokasiKegiatan" name="lokasiKegiatan" value="<?php echo $kegiatan['lokasi']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="kapasitasKegiatan" class="form-label">Kapasitas Kegiatan</label>
                        <input type="number" class="form-control" id="kapasitasKegiatan" name="kapasitasKegiatan" value="<?php echo $kegiatan['kapasitas']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="fotoKegiatan" class="form-label">Foto Kegiatan</label>
                        <input type="file" class="form-control" id="fotoKegiatan" name="fotoKegiatan" >
                        <span><?php echo $kegiatan['foto']; ?></span>
                    </div>
