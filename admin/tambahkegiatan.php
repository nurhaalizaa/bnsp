          ...
          <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="prosestambah.php" enctype="multipart/form-data">
                    ...
                    <input type="date" class="form-control" id="tanggalKegiatan" name="tanggalKegiatan" required>
                    </div>
                    <div class="mb-3">
                    <label for="waktuKegiatan" class="form-label">Waktu</label>
                    <input type="time" class="form-control" id="waktuKegiatan" name="waktuKegiatan" required>
                    </div>
                    <div class="mb-3">
                    <label for="lokasiKegiatan" class="form-label">Lokasi</label>
                    <input type="text" class="form-control" id="lokasiKegiatan" name="lokasiKegiatan" required>
                    </div>
                    <div class="mb-3">
                    <label for="kapasitasKegiatan" class="form-label">Kapasitas</label>
                    <input type="number" class="form-control" id="kapasitasKegiatan" name="kapasitasKegiatan" required>
                    </div>
                    <div class="mb-3">
                    <label for="fotoKegiatan" class="form-label">Foto Kegiatan</label>
                    <input type="file" class="form-control" id="fotoKegiatan" name="fotoKegiatan" required>
                    </div>
